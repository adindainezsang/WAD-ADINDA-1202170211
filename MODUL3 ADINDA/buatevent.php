...
<html lang="en">
    ...
    <p>
     ...
     <h4 class="text" style="color: #31C0EC; font-family: Poppins; margin-left: 30px;">Buat Event</h4><br>
     ...
     <div class="card" style="margin-left: 30px; margin-bottom:30px; font-family: Poppins">
            ...
            <div class="form-group">
                ...
                <input type="input" name="tempat" class="form-control" id="tempat" aria-describedby="namaHelp">
            </div>


            <div class="form-group">
                <label for="InputHarga">Harga</label>
                <input type="input" name="harga"class="form-control" id="harga" aria-describedby="namaHelp">
            </div>
